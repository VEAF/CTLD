...
| `troopPickupAtFARP` | `true` | Autorise le pickup de troops aux FARP construites |
...
| `farpTroopPickupRadius` | `150` | Rayon (m) dans lequel les troops peuvent embarquer à une FARP |
