...
-- STALE: ctld.i18n["ko"]["Mortar Squad Red"] = "레드 박격포 분대"
...
-- STALE: ctld.i18n["ko"]["KAMAZ Ammo Truck - All crates"] = "KAMAZ 탄약 차량 - 전체 화물"
...
-- STALE: ctld.i18n["ko"]["HAWK Launcher"] = "호크 포대"
-- STALE: ctld.i18n["ko"]["HAWK Search Radar"] = "호크 탐지 레이더"
-- STALE: ctld.i18n["ko"]["HAWK Track Radar"] = "호크 추적 레이더"
-- STALE: ctld.i18n["ko"]["HAWK PCP"] = "호크 PCP"
-- STALE: ctld.i18n["ko"]["HAWK CWAR"] = "호크 CWAR"
-- STALE: ctld.i18n["ko"]["HAWK Repair"] = "호크 수리킷"
-- STALE: ctld.i18n["ko"]["NASAMS Launcher 120C"] = "NASAMS 포대 120C"
-- STALE: ctld.i18n["ko"]["NASAMS Search/Track Radar"] = "NASAMS 레이더"
-- STALE: ctld.i18n["ko"]["NASAMS Command Post"] = "NASAMS 관제소"
-- STALE: ctld.i18n["ko"]["NASAMS Repair"] = "NASAMS 수리킷"
-- STALE: ctld.i18n["ko"]["KUB Launcher"] = "SA-6 포대"
-- STALE: ctld.i18n["ko"]["KUB Radar"] = "SA-6 레이더"
-- STALE: ctld.i18n["ko"]["KUB Repair"] = "SA-6 수리킷"
-- STALE: ctld.i18n["ko"]["BUK Launcher"] = "SA-11 포대"
-- STALE: ctld.i18n["ko"]["BUK Search Radar"] = "SA-11 탐지 레이더"
-- STALE: ctld.i18n["ko"]["BUK CC Radar"] = "SA-11 CC"
-- STALE: ctld.i18n["ko"]["BUK Repair"] = "SA-11 수리킷"
-- STALE: ctld.i18n["ko"]["Patriot Launcher"] = "패트리어트 포대"
-- STALE: ctld.i18n["ko"]["Patriot Radar"] = "패트리어트 탐지 레이더"
-- STALE: ctld.i18n["ko"]["Patriot ECS"] = "패트리어트 ECS"
-- STALE: ctld.i18n["ko"]["Patriot ICC"] = "패트리어트 ICC"
-- STALE: ctld.i18n["ko"]["Patriot EPP"] = "패트리어트 EPP"
-- STALE: ctld.i18n["ko"]["Patriot AMG (optional)"] = "패트리어트 AMG (선택 사항)"
-- STALE: ctld.i18n["ko"]["Patriot Repair"] = "패트리어트 수리킷"
-- STALE: ctld.i18n["ko"]["S-300 Grumble TEL C"] = "S-300 C 포대"
-- STALE: ctld.i18n["ko"]["S-300 Grumble Flap Lid-A TR"] = "S-300 5N63 추적 레이더"
-- STALE: ctld.i18n["ko"]["S-300 Grumble Clam Shell SR"] = "S-300 Clam Shell 탐지 레이더"
-- STALE: ctld.i18n["ko"]["S-300 Grumble Big Bird SR"] = "S-300 Big Bird 탐지 레이더"
-- STALE: ctld.i18n["ko"]["S-300 Grumble C2"] = "S-300 관제소"
-- STALE: ctld.i18n["ko"]["S-300 Repair"] = "S-300 수리킷"
...
--- F10 RECON menus
-- STALE: ctld.i18n["ko"]["activate"] = "활성화"
-- STALE: ctld.i18n["ko"]["deactivate"] = "비활성화"
ctld.i18n["ko"]["RECON"] = "정찰"
ctld.i18n["ko"]["RECON [Start]"] = "정찰 [시작]"
ctld.i18n["ko"]["RECON [Stop]"] = "정찰 [정지]"
-- STALE: ctld.i18n["ko"]["Scan Area"] = "구역 스캔"
-- STALE: ctld.i18n["ko"]["Hide All Targets"] = "모든 목표 숨기기"
-- STALE: ctld.i18n["ko"]["Toggle %s"] = "%s 전환"
-- STALE: ctld.i18n["ko"]["Auto-Refresh: [OFF]"] = "자동 갱신: [꺼짐]"
-- STALE: ctld.i18n["ko"]["Auto-Refresh: [ON]"] = "자동 갱신: [켜짐]"
ctld.i18n["ko"]["Altitude too low for recon scan (min %1 m)"] = "정찰 스캔 고도 부족 (최소 %1 m)"
-- STALE: ctld.i18n["ko"]["No recon layers enabled. Activate layers first."] = "활성화된 정찰 레이어 없음. 먼저 레이어를 활성화하세요."
...
-- STALE: ctld.i18n["ko"]["No active recon scan to hide."] = "숨길 활성 정찰 스캔 없음."
ctld.i18n["ko"]["No active recon scan. Use 'Scan Area' first."] = "활성 정찰 스캔 없음."
-- STALE: ctld.i18n["ko"]["Auto-refresh enabled. Targets update every %1 s."] = "자동 갱신 활성화. %1 초마다 목표 업데이트."
...
-- STALE: ctld.i18n["ko"]["2K22 Tunguska - All crates"] = "2K22 퉁구스카 - 전체 화물"
-- STALE: ctld.i18n["ko"]["9K33 Osa - All crates"] = "9K33 오사 - 전체 화물"
-- STALE: ctld.i18n["ko"]["9K331 Tor - All crates"] = "9K331 토르 - 전체 화물"
-- STALE: ctld.i18n["ko"]["9K35M Strela-10 - All crates"] = "9K35M 스트렐라-10 - 전체 화물"
-- STALE: ctld.i18n["ko"]["9P31 Strela-1 - All crates"] = "9P31 스트렐라-1 - 전체 화물"
-- STALE: ctld.i18n["ko"]["BUK - All crates"] = "SA-11 - 전체 화물"
-- STALE: ctld.i18n["ko"]["EWR Radar - All crates"] = "조기경보 레이더 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Gepard AAA - All crates"] = "게파트 자주대공포 - 전체 화물"
-- STALE: ctld.i18n["ko"]["HAWK - All crates"] = "호크 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Heavy Tank - Abrams - All crates"] = "M1 에이브럼스 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Howitzer - All crates"] = "곡사포 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Hummer - JTAC - All crates"] = "험머 - JTAC - 전체 화물"
-- STALE: ctld.i18n["ko"]["Humvee - TOW - All crates"] = "험비 - TOW - 전체 화물"
-- STALE: ctld.i18n["ko"]["KUB - All crates"] = "SA-6 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Light Tank - MRAP - All crates"] = "경전차 - MRAP - 전체 화물"
-- STALE: ctld.i18n["ko"]["LPWS C-RAM - All crates"] = "LPWS C-RAM - 전체 화물"
-- STALE: ctld.i18n["ko"]["M1097 Avenger - All crates"] = "M1097 어벤저 - 전체 화물"
-- STALE: ctld.i18n["ko"]["M48 Chaparral - All crates"] = "M48 채퍼럴 - 전체 화물"
-- STALE: ctld.i18n["ko"]["M-818 Ammo Truck - All crates"] = "M-818 탄약 차량 - 전체 화물"
-- STALE: ctld.i18n["ko"]["M-978 Tanker - All crates"] = "M-978 연료 차량 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Med Tank - LAV-25 - All crates"] = "중형 전차 - LAV-25 - 전체 화물"
-- STALE: ctld.i18n["ko"]["MLRS - All crates"] = "MLRS - 전체 화물"
-- STALE: ctld.i18n["ko"]["NASAMS - All crates"] = "NASAMS - 전체 화물"
-- STALE: ctld.i18n["ko"]["Patriot - All crates"] = "패트리어트 - 전체 화물"
-- STALE: ctld.i18n["ko"]["S-300 - All crates"] = "S-300 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Roland ADS - All crates"] = "롤랑 ADS - 전체 화물"
-- STALE: ctld.i18n["ko"]["SpGH DANA - All crates"] = "DANA 자주곡사포 - 전체 화물"
-- STALE: ctld.i18n["ko"]["SPH 2S19 Msta - All crates"] = "2S19 므스타 - 전체 화물"
-- STALE: ctld.i18n["ko"]["T155 Firtina - All crates"] = "T-155 프르트나 - 전체 화물"
-- STALE: ctld.i18n["ko"]["Ural-375 Ammo Truck - All crates"] = "Ural-375 탄약 차량 - 전체 화물"
...
-- STALE: ctld.i18n["ko"]["You must be on the ground to deploy a FARP."] = "FARP를 배치하려면 착륙해야 합니다."
...
-- STALE: ctld.i18n["ko"]["Land to pack vehicles"] = "차량을 포장하려면 착륙하세요"
-- STALE: ctld.i18n["ko"]["No packable vehicles nearby"] = "근처에 포장 가능한 차량 없음"
...
-- STALE: ctld.i18n["ko"]["You must be landed to request JTAC equipment."] = "JTAC 장비를 요청하려면 착륙해야 합니다."
...
-- STALE: ctld.i18n["ko"]["Smoke auto-resume ON (%1s interval)"]  = "연막 자동재개 ON (%1초 간격)"
-- STALE: ctld.i18n["ko"]["Smoke auto-resume OFF"]                = "연막 자동재개 OFF"
...
-- STALE: ctld.i18n["ko"]["Unload Troops"]                              = "병력 하차"
-- STALE: ctld.i18n["ko"]["Unload All"]                                 = "전체 하차"
...
ctld.i18n["ko"]["INIT-E: extractableGroup '%1' not found in mission — skipped"]            = "INIT-E: extractableGroup '%1'을(를) 임무에서 찾을 수 없음 — 건너뜀"
ctld.i18n["ko"]["[CTLD] Config errors detected — search CTLD_STARTUP_REPORT in DCS.log"]  = "[CTLD] 설정 오류 발견 — DCS.log에서 CTLD_STARTUP_REPORT 검색"

--- Keys added by generate_i18n_dicts.ps1 on 2026-07-22
ctld.i18n["ko"]["--- Countryside FARP Deployment by %1 : Complete! ---"] = "--- %1의 야외 FARP 배치 : 완료! ---"
ctld.i18n["ko"]["--- FARP Dynamic Deployment by %1 : Complete! ---"] = "--- %1의 동적 FARP 배치 : 완료! ---"
ctld.i18n["ko"]["--- mineField Deployed by %1 ---"] = "--- %1이(가) 배치한 지뢰밭 ---"
ctld.i18n["ko"]["%1 [%2] %3."] = "%1 [%2] %3."
ctld.i18n["ko"]["%1 crate dropped below you."] = "%1 화물이 당신 아래로 투하되었습니다."
ctld.i18n["ko"]["%1 crate safely released."] = "%1 화물이 안전하게 분리되었습니다."
ctld.i18n["ko"]["%1 packed into %2 crate(s)."] = "%1이(가) %2개의 화물로 포장되었습니다."
...
ctld.i18n["ko"]["Cargo: [%1] — %2 troops, %3 kg"] = "화물: [%1] — 병력 %2명, %3 kg"
ctld.i18n["ko"]["Clear Mine Field (%1 mines, ~%2 m)"] = "지뢰밭 제거 (지뢰 %1개, ~%2 m)"
ctld.i18n["ko"]["Crate Commands"] = "화물 명령"
ctld.i18n["ko"]["Cut Slingload"] = "슬링로드 절단"
ctld.i18n["ko"]["Drop Blue Smoke"] = ""
ctld.i18n["ko"]["Drop Crate(s)"] = ""
ctld.i18n["ko"]["Drop Green Smoke"] = ""
ctld.i18n["ko"]["Drop Orange Smoke"] = ""
ctld.i18n["ko"]["Drop Red Smoke"] = ""
ctld.i18n["ko"]["Extracted [%1] (%2 troops)."] = "추출됨 [%1] (%2명)."
ctld.i18n["ko"]["FOB 90% complete - final installation in progress..."] = "FOB 90% 완료 - 최종 설치 진행 중..."
ctld.i18n["ko"]["FOB construction started by %1."] = "%1이(가) FOB 건설을 시작했습니다."
ctld.i18n["ko"]["FOB established by %1 - logistics hub now active."] = "%1이(가) FOB를 설립했습니다 - 군수 거점 활성화됨."
ctld.i18n["ko"]["Group too large for this aircraft (%1/%2 troops)."] = "그룹이 이 항공기에 비해 너무 큽니다 (%1/%2명)."
ctld.i18n["ko"]["Hovering above %s crate.\n\nHold hover for %d seconds!\n\nIf the countdown stops you're too far away!"] = "%s 화물 위에서 정지 비행 중.\n\n%d초 동안 정지 비행을 유지하세요!\n\n카운트다운이 멈추면 너무 멀리 떨어진 것입니다!"
ctld.i18n["ko"]["Infantry coalition limit reached, cannot load more troops."] = "보병 연합 한도에 도달하여 더 이상 병력을 태울 수 없습니다."
ctld.i18n["ko"]["into %1"] = "%1(으)로"
ctld.i18n["ko"]["into combat"] = "전투로"
ctld.i18n["ko"]["JTAC"] = "JTAC"
ctld.i18n["ko"]["JTAC Group 2"] = "JTAC 그룹 2"
ctld.i18n["ko"]["JTAC Status"] = ""
ctld.i18n["ko"]["Land near troops to extract them (%1m away)."] = "병력 근처에 착륙하여 추출하세요 (%1m 거리)."
ctld.i18n["ko"]["Load "] = ""
ctld.i18n["ko"]["Load / Extract Vehicles"] = ""
ctld.i18n["ko"]["Load from %1"] = "%1에서 적재"
ctld.i18n["ko"]["Loaded: %1 (%2 troops)."] = "적재됨: %1 (%2명)."
...
ctld.i18n["ko"]["No crates loaded."] = "적재된 화물 없음."
ctld.i18n["ko"]["No extractable troops nearby!"] = ""
ctld.i18n["ko"]["No slingloaded crate on board."] = "탑재된 슬링로드 화물 없음."
ctld.i18n["ko"]["no target"] = "목표 없음"
ctld.i18n["ko"]["No troops onboard and no extractable troops nearby."] = "탑승 병력 없음, 근처에 추출 가능한 병력도 없음."
ctld.i18n["ko"]["Out of parts for AA Systems. Current limit is %1\n"] = ""
ctld.i18n["ko"]["Parachute Crates"] = "화물 낙하산 투하"
ctld.i18n["ko"]["Parachute Troops"] = "병력 낙하산 투하"
ctld.i18n["ko"]["Parachute Vehicle"] = "차량 낙하산 투하"
ctld.i18n["ko"]["RECON is disabled (set reconF10Menu=true in config)."] = "정찰이 비활성화되어 있습니다 (설정에서 reconF10Menu=true로 지정하세요)."
ctld.i18n["ko"]["Release Slingload"] = "슬링로드 해제"
ctld.i18n["ko"]["Request 9-Line"] = "9-Line 요청"
ctld.i18n["ko"]["Request Equipment"] = "장비 요청"
ctld.i18n["ko"]["Request Smoke on Target"] = "목표에 연막 요청"
ctld.i18n["ko"]["Slingloaded %1 crate!"] = "%1 화물을 슬링로드했습니다!"
ctld.i18n["ko"]["Smoke"] = "연막"
ctld.i18n["ko"]["This pickup zone is empty."] = "이 픽업 구역은 비어 있습니다."
ctld.i18n["ko"]["This pickup zone is not active."] = "이 픽업 구역은 활성화되어 있지 않습니다."
ctld.i18n["ko"]["This pickup zone is not available to your coalition."] = "이 픽업 구역은 당신의 연합이 사용할 수 없습니다."
ctld.i18n["ko"]["Too fast! Slingloaded crate lost: %1"] = "너무 빠릅니다! 슬링로드 화물 손실: %1"
-- STALE: ctld.i18n["ko"]["Too high or too fast to drop troops! Hover below %1 ft or land."] = ""
ctld.i18n["ko"]["Too high to fast-rope! Descend below %1 ft."] = "너무 높아서 패스트로프를 할 수 없습니다! %1피트 이하로 하강하세요."
ctld.i18n["ko"]["Too fast to fast-rope! Slow down and hover."] = "너무 빨라서 패스트로프를 할 수 없습니다! 속도를 줄이고 정지비행하세요."
ctld.i18n["ko"]["Too high to hook crate.\n\nHold hover for %1 seconds"] = "너무 높아서 화물을 걸 수 없습니다.\n\n%1초 동안 정지비행을 유지하세요"
ctld.i18n["ko"]["Too high to release slingload. Descend below %1m AGL (current: %2m AGL)."] = "너무 높아서 슬링로드를 해제할 수 없습니다. %1m AGL 이하로 하강하세요 (현재: %2m AGL)."
ctld.i18n["ko"]["Too high! %1 crate destroyed on impact."] = "너무 높습니다! %1 화물이 충돌로 파괴되었습니다."
ctld.i18n["ko"]["Too low to hook crate.\n\nHold hover for %1 seconds"] = "너무 낮아서 화물을 걸 수 없습니다.\n\n%1초 동안 정지비행을 유지하세요"
ctld.i18n["ko"]["Troop Commands"] = "병력 명령"
ctld.i18n["ko"]["Troops returned to base."] = "병력이 기지로 복귀했습니다."
ctld.i18n["ko"]["Unload Vehicles"] = ""
ctld.i18n["ko"]["Vehicle Commands"] = "차량 명령"
ctld.i18n["ko"]["You must land inside the pickup zone to load troops."] = "병력을 태우려면 픽업 구역 안에 착륙해야 합니다."
ctld.i18n["ko"]["You must land to extract troops."] = "병력을 추출하려면 착륙해야 합니다."
ctld.i18n["ko"]["Zone not found."] = "구역을 찾을 수 없습니다."
...
ctld.i18n["ko"]["Cannot deploy %1: AA system limit reached (%2/%3)"] = "%1을(를) 배치할 수 없습니다: AA 시스템 한도 도달 (%2/%3)"
ctld.i18n["ko"]["Cannot repair %1. No damaged %1 within %2m"] = "%1을(를) 수리할 수 없습니다. %2m 이내에 손상된 %1 없음"
...
--- Keys added by generate_i18n_dicts.ps1 on 2026-07-30
ctld.i18n["ko"]["specificParams is ignored on crates (%1) — drone orbit altitude, radii and speed now come from the JTAC_drone* settings"] = "specificParams는 화물(%1)에서 무시됩니다 — 드론 궤도 고도, 반경, 속도는 이제 JTAC_drone* 설정에서 가져옵니다"

--- Keys added by generate_i18n_dicts.ps1 on 2026-08-01
ctld.i18n["ko"]["dropOffZones is not read by CTLD 2 — declare each AI drop-off point as an aiZones entry with isDropoff: true"] = "dropOffZones는 CTLD 2에서 읽지 않습니다 — 각 AI 하차 지점을 isDropoff: true로 aiZones 항목으로 선언하세요"

--- Keys added by generate_i18n_dicts.ps1 on 2026-08-01
ctld.i18n["ko"]["  AIZ[%1] ERROR '%2': name already taken by zone '%3' — entry ignored"] = "  AIZ[%1] 오류 '%2': 이름이 이미 구역 '%3'에서 사용 중 — 항목 무시됨"
