...
ctld.i18n["es"] = {}
ctld.i18n["es"].translation_version = "1.18"
...
-- STALE: ctld.i18n["es"]["Extract: %1"]                                = "Extraer: %1"
...
ctld.i18n["es"]["INIT-E: extractableGroup '%1' not found in mission — skipped"]            = "INIT-E: extractableGroup '%1' no encontrado en la misión — omitido"
ctld.i18n["es"]["[CTLD] Config errors detected — search CTLD_STARTUP_REPORT in DCS.log"]  = "[CTLD] Errores de configuración detectados — buscar CTLD_STARTUP_REPORT en DCS.log"

--- Keys added by generate_i18n_dicts.ps1 on 2026-07-22
ctld.i18n["es"]["--- Countryside FARP Deployment by %1 : Complete! ---"] = "--- Despliegue de FARP rural por %1 : ¡Completado! ---"
ctld.i18n["es"]["--- FARP Dynamic Deployment by %1 : Complete! ---"] = "--- Despliegue dinámico de FARP por %1 : ¡Completado! ---"
ctld.i18n["es"]["--- mineField Deployed by %1 ---"] = "--- Campo minado desplegado por %1 ---"
ctld.i18n["es"]["%1 [%2] %3."] = "%1 [%2] %3."
ctld.i18n["es"]["%1 crate dropped below you."] = "La caja %1 ha caído debajo de ti."
ctld.i18n["es"]["%1 crate safely released."] = "La caja %1 se ha soltado de forma segura."
ctld.i18n["es"]["%1 packed into %2 crate(s)."] = "%1 empaquetado en %2 caja(s)."
ctld.i18n["es"]["[activate]"] = "[activar]"
ctld.i18n["es"]["[deactivate]"] = "[desactivar]"
ctld.i18n["es"]["Cargo: [%1] — %2 troops, %3 kg"] = "Carga: [%1] — %2 tropas, %3 kg"
ctld.i18n["es"]["Clear Mine Field (%1 mines, ~%2 m)"] = "Despejar campo minado (%1 minas, ~%2 m)"
ctld.i18n["es"]["Crate Commands"] = "Comandos de cajas"
ctld.i18n["es"]["Cut Slingload"] = "Cortar eslinga"
ctld.i18n["es"]["Extracted [%1] (%2 troops)."] = "Extraído [%1] (%2 tropas)."
ctld.i18n["es"]["FOB 90% complete - final installation in progress..."] = "FOB al 90% completado - instalación final en curso..."
ctld.i18n["es"]["FOB construction started by %1."] = "%1 inició la construcción de un FOB."
ctld.i18n["es"]["FOB established by %1 - logistics hub now active."] = "FOB establecido por %1 - centro logístico activo."
ctld.i18n["es"]["Group too large for this aircraft (%1/%2 troops)."] = "El grupo es demasiado grande para esta aeronave (%1/%2 tropas)."
ctld.i18n["es"]["Hovering above %s crate.\n\nHold hover for %d seconds!\n\nIf the countdown stops you're too far away!"] = "En estacionario sobre la caja %s.\n\n¡Mantén el estacionario durante %d segundos!\n\n¡Si la cuenta atrás se detiene, estás demasiado lejos!"
ctld.i18n["es"]["Infantry coalition limit reached, cannot load more troops."] = "Límite de infantería de la coalición alcanzado, no se pueden cargar más tropas."
ctld.i18n["es"]["into %1"] = "en %1"
ctld.i18n["es"]["into combat"] = "al combate"
ctld.i18n["es"]["JTAC"] = "JTAC"
ctld.i18n["es"]["JTAC Group 2"] = "Grupo JTAC 2"
ctld.i18n["es"]["Land near troops to extract them (%1m away)."] = "Aterriza cerca de las tropas para extraerlas (a %1m)."
ctld.i18n["es"]["Load from %1"] = "Cargar desde %1"
ctld.i18n["es"]["Loaded: %1 (%2 troops)."] = "Cargado: %1 (%2 tropas)."
ctld.i18n["es"]["Mine Field"] = "Campo minado"
ctld.i18n["es"]["Mine Field cleared by %1."] = "Campo minado despejado por %1."
ctld.i18n["es"]["No active JTACs."] = "Sin JTAC activos."
ctld.i18n["es"]["No crates loaded."] = "No hay cajas cargadas."
ctld.i18n["es"]["No slingloaded crate on board."] = "No hay carga en eslinga a bordo."
ctld.i18n["es"]["no target"] = "sin objetivo"
ctld.i18n["es"]["No troops onboard and no extractable troops nearby."] = "Sin tropas a bordo y sin tropas extraíbles cerca."
ctld.i18n["es"]["Parachute Crates"] = "Lanzar cajas en paracaídas"
ctld.i18n["es"]["Parachute Troops"] = "Lanzar tropas en paracaídas"
ctld.i18n["es"]["Parachute Vehicle"] = "Lanzar vehículo en paracaídas"
ctld.i18n["es"]["RECON is disabled (set reconF10Menu=true in config)."] = "RECON está desactivado (establece reconF10Menu=true en la configuración)."
ctld.i18n["es"]["Release Slingload"] = "Soltar eslinga"
ctld.i18n["es"]["Request 9-Line"] = "Solicitar 9-Line"
ctld.i18n["es"]["Request Equipment"] = "Solicitar equipo"
ctld.i18n["es"]["Request Smoke on Target"] = "Solicitar humo sobre el objetivo"
ctld.i18n["es"]["Slingloaded %1 crate!"] = "¡Caja %1 enganchada en eslinga!"
ctld.i18n["es"]["Smoke"] = "Humo"
ctld.i18n["es"]["This pickup zone is empty."] = "Esta zona de recogida está vacía."
ctld.i18n["es"]["This pickup zone is not active."] = "Esta zona de recogida no está activa."
ctld.i18n["es"]["This pickup zone is not available to your coalition."] = "Esta zona de recogida no está disponible para tu coalición."
ctld.i18n["es"]["Too fast! Slingloaded crate lost: %1"] = "¡Demasiado rápido! Caja en eslinga perdida: %1"
-- STALE: ctld.i18n["es"]["Too high or too fast to drop troops! Hover below %1 ft or land."] = ""
ctld.i18n["es"]["Too high to fast-rope! Descend below %1 ft."] = "¡Demasiado alto para descolgarse con cuerda rápida! Desciende por debajo de %1 pies."
ctld.i18n["es"]["Too fast to fast-rope! Slow down and hover."] = "¡Demasiado rápido para descolgarse con cuerda rápida! Reduce la velocidad y mantente en estacionario."
ctld.i18n["es"]["Too high to hook crate.\n\nHold hover for %1 seconds"] = "Demasiado alto para enganchar la caja.\n\nMantén el estacionario durante %1 segundos"
ctld.i18n["es"]["Too high to release slingload. Descend below %1m AGL (current: %2m AGL)."] = "Demasiado alto para soltar la eslinga. Desciende por debajo de %1m AGL (actual: %2m AGL)."
ctld.i18n["es"]["Too high! %1 crate destroyed on impact."] = "¡Demasiado alto! La caja %1 se destruyó al impactar."
ctld.i18n["es"]["Too low to hook crate.\n\nHold hover for %1 seconds"] = "Demasiado bajo para enganchar la caja.\n\nMantén el estacionario durante %1 segundos"
ctld.i18n["es"]["Troop Commands"] = "Comandos de tropas"
ctld.i18n["es"]["Troops returned to base."] = "Tropas devueltas a la base."
ctld.i18n["es"]["Vehicle Commands"] = "Comandos de vehículos"
ctld.i18n["es"]["You must land inside the pickup zone to load troops."] = "Debes aterrizar dentro de la zona de recogida para cargar tropas."
ctld.i18n["es"]["You must land to extract troops."] = "Debes aterrizar para extraer tropas."
ctld.i18n["es"]["Zone not found."] = "Zona no encontrada."
...
ctld.i18n["es"]["Cannot deploy %1: AA system limit reached (%2/%3)"] = "No se puede desplegar %1: límite de sistemas AA alcanzado (%2/%3)"
...
--- Keys added by generate_i18n_dicts.ps1 on 2026-07-30
ctld.i18n["es"]["specificParams is ignored on crates (%1) — drone orbit altitude, radii and speed now come from the JTAC_drone* settings"] = "specificParams se ignora en las cajas (%1) — la altitud de órbita, los radios y la velocidad del dron ahora provienen de los ajustes JTAC_drone*"

--- Keys added by generate_i18n_dicts.ps1 on 2026-08-01
ctld.i18n["es"]["dropOffZones is not read by CTLD 2 — declare each AI drop-off point as an aiZones entry with isDropoff: true"] = "dropOffZones no es leído por CTLD 2 — declara cada punto de descarga de IA como una entrada aiZones con isDropoff: true"

--- Keys added by generate_i18n_dicts.ps1 on 2026-08-01
ctld.i18n["es"]["  AIZ[%1] ERROR '%2': name already taken by zone '%3' — entry ignored"] = "  AIZ[%1] ERROR '%2': nombre ya utilizado por la zona '%3' — entrada ignorada"

--- Keys added by generate_i18n_dicts.ps1 on 2026-08-09
ctld.i18n["es"]["%1 (%2 troops, %3m)"] = "%1 (%2 tropas, %3 m)"
ctld.i18n["es"]["Extract: %1 (%2 troops)"] = "Extraer: %1 (%2 tropas)"
