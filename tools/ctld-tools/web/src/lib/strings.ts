...
export const EN_STRINGS: Record<string, string> = {
  ...
  'web.aizone.troop_stock_missing_tip': "Troop pickup is disabled here until troopStock is set",
  'web.aizone.unlimited': "unlimited",
  'web.aizone.untitled': "New AI zone",
  'web.aizone.vehicle_stock_absent_tip': "No virtual stock set — this zone only offers a vehicle physically placed in the Mission Editor",
