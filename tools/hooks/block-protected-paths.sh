...
#   - CTLD.lua         : the generated deliverable (edit src/ and rebuild)
...
case "$norm" in
    */migration/source/*|migration/source/*)
        ...
        ;;
    */CTLD.lua|CTLD.lua)
        echo "Blocked: 'CTLD.lua' is a generated artifact. Edit files under src/ and rebuild with tools/build/merge_CTLD.ps1 (see dev/adr/0001)." >&2
        exit 2
        ;;
esac
