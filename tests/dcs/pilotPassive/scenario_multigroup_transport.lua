...
if not ctld or not ctld.utils then
    ...
    _SCN_MG_TRANSPORT_RESULT = "[MG-TRANSPORT] ABORT: CTLD not initialized"
    return _SCN_MG_TRANSPORT_RESULT
end
...
_SCN_MG_TRANSPORT_RESULT  = "[MG-TRANSPORT] STARTED"
...
local function finalizeScenario()
    ...
    local summary
    if S.failed == 0 then
        summary = TAG.." PASS "..S.passed.."/"..total ; _SCN_MGTRANSPORT_RESULT = summary
    else
        summary = TAG.." FAIL "..S.failed.."/"..total..": "..
            table.concat(S.failReasons, "; ") ; _SCN_MGTRANSPORT_RESULT = summary
    end
    log(summary)
...
if not playerObjStart then
    ...
    _SCN_MGTRANSPORT_RESULT = "[MG-TRANSPORT] ABORT"
    cleanup() ; return _SCN_MGTRANSPORT_RESULT
end
