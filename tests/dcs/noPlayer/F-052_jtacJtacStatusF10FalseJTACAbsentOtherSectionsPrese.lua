---@diagnostic disable
-- F-52 : JTAC_jtacStatusF10=false → JTAC absent; other sections present
...
ctld_test.start("F-52", "JTAC_jtacStatusF10=false — JTAC absent")
...
ctld.gs = function(k)
    ...
    if k=="JTAC_jtacStatusF10"     then return false end  -- OFF
...
local playerObj = {
    unitName="UH-1H-1", groupId=9901, groupName="Grp_F52",
...
ctld_test.assert(not has({root, ctld.tr("JTAC")}),           "JTAC absent (JTAC_jtacStatusF10=false)")
