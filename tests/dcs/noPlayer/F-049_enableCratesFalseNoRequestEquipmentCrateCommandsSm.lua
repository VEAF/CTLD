...
ctld.gs = function(k)
    if k=="enableCrates"           then return false end  -- OFF
...
local playerObj = {
    unitName="UH-1H-1", groupId=9901, groupName="Grp_F49",
...
ctld_test.assert(has({root, ctld.tr("Troop Commands")}),      "Troop Commands present (not gated by enableCrates)")
