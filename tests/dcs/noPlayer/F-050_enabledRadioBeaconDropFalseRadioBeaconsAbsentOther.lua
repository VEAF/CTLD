---@diagnostic disable
-- F-50 : enabledRadioBeaconDrop=false → Radio Beacons absent; other sections present
...
ctld_test.start("F-50", "enabledRadioBeaconDrop=false — Radio Beacons absent")
...
ctld.gs = function(k)
    ...
    if k=="enabledRadioBeaconDrop" then return false end  -- OFF
...
local playerObj = {
    unitName="UH-1H-1", groupId=9901, groupName="Grp_F50",
