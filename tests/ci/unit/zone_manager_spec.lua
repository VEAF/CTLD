...
-- busted specs for CTLDZoneManager.parseTRZ/_parseLGZ and CTLDTroopZone/CTLDLogisticZone
-- Reference: live_tests/unit/U-008 through U-013
-- ============================================================

-- ─────────────────────────────────────────────────────────────
describe("CTLDZoneManager.parseTRZ", function()
    ...
    describe("valid formats", function()
        ...
        it("parses limited-pickup zone TRZ_alpha_B_10_nil_0", function()
            local r, e = zm:parseTRZ("TRZ_alpha_B_10_nil_0")
            assert.is_not_nil(r)
            assert.is_nil(e)
        ...
        it("parses unlimited-pickup zone TRZ_bravo_A_999_nil_0", function()
            local r, e = zm:parseTRZ("TRZ_bravo_A_999_nil_0")
            assert.is_not_nil(r)
            assert.is_nil(e)
        ...
        it("parses extract-only zone TRZ_charlie_R_0_obj1_0", function()
            local r, e = zm:parseTRZ("TRZ_charlie_R_0_obj1_0")
            assert.is_not_nil(r)
            assert.is_nil(e)
        ...
        it("parses zone with objective target TRZ_delta_B_0_win_50", function()
            local r, e = zm:parseTRZ("TRZ_delta_B_0_win_50")
            assert.is_not_nil(r)
            assert.is_nil(e)
        ...
        it("parses mixed pickup+extract zone TRZ_echo_N_20_rescue_100", function()
            local r, e = zm:parseTRZ("TRZ_echo_N_20_rescue_100")
            assert.is_not_nil(r)
            assert.is_nil(e)
        ...
        it("parses coalition-all zone TRZ_foxtrot_A_5_nil_0", function()
            local r, e = zm:parseTRZ("TRZ_foxtrot_A_5_nil_0")
            assert.is_not_nil(r)
            assert.is_nil(e)
    ...
    describe("invalid formats", function()
        ...
        it("rejects wrong prefix LGZ_...", function()
            local r, e = zm:parseTRZ("LGZ_alpha_B_10_nil_0")
            assert.is_nil(r)
            assert.is_not_nil(e)
        ...
        it("rejects 'TRZ_' (empty zoneName)", function()
            local r, _ = zm:parseTRZ("TRZ_")
            assert.is_nil(r)
        end)

        it("rejects reserved zoneName 'nil'", function()
            local r, e = zm:parseTRZ("TRZ_nil_B_10_nil_0")
            assert.is_nil(r)
            assert.is_not_nil(e)
        ...
        it("rejects reserved zoneName 'A'", function()
            local r, e = zm:parseTRZ("TRZ_A_B_10_nil_0")
            assert.is_nil(r)
            assert.is_not_nil(e)
        end)

        it("rejects missing coalition (TRZ_alpha)", function()
            local r, e = zm:parseTRZ("TRZ_alpha")
            assert.is_nil(r)
            assert.is_not_nil(e)
        ...
        it("rejects invalid coalition 'X'", function()
            local r, e = zm:parseTRZ("TRZ_alpha_X_10_nil_0")
            assert.is_nil(r)
            assert.is_not_nil(e)
            assert.is_not_nil(e:find("coalition"))
        end)
        ...
        it("rejects missing stock (TRZ_alpha_B)", function()
            local r, e = zm:parseTRZ("TRZ_alpha_B")
            assert.is_nil(r)
            assert.is_not_nil(e)
        ...
        it("rejects out-of-range stock 1000", function()
            local r, e = zm:parseTRZ("TRZ_alpha_B_1000_nil_0")
            assert.is_nil(r)
            assert.is_not_nil(e)
            assert.is_not_nil(e:find("stock"))
        end)
        ...
        it("rejects negative stock -5", function()
            local r, e = zm:parseTRZ("TRZ_alpha_B_-5_nil_0")
            assert.is_nil(r)
            assert.is_not_nil(e)
        end)

        it("rejects numeric flag", function()
            local r, e = zm:parseTRZ("TRZ_alpha_B_10_42_0")
            assert.is_nil(r)
            assert.is_not_nil(e)
        ...
        it("rejects missing target (4 fields)", function()
            local r, e = zm:parseTRZ("TRZ_alpha_B_10_nil")
            assert.is_nil(r)
            assert.is_not_nil(e)
        ...
        it("rejects negative target -1", function()
            local r, e = zm:parseTRZ("TRZ_alpha_B_10_nil_-1")
            assert.is_nil(r)
            assert.is_not_nil(e)
            assert.is_not_nil(e:find("target"))
        end)
