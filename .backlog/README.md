...
| `BUILD-DICT-AUTOSYNC` | 🔄 in progress | Intégrer `generate_i18n_dicts.ps1 -Apply` dans `merge_CTLD.ps1` + hook `pre-push` cross-platform (bloquant sur MISSING, warn sur STALE) + doc activation dans `CLAUDE.md`. | `fix/build-dict-autosync` |
