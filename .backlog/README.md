...
|-----|--------|-------------|--------|
| `FIX-CTLD-TOOLS-REVIEW` | pending merge | Findings from FullGas's manual review of PR #68 — a data-corrupting editor, double-encoded FR text, a dead catalogue key, and three editor gaps |
