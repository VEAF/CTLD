...
**Status:** delivered. Compacted from `DOC-USER-ROLES/` on 2026-08-01; the ticket files live on in git history.

Bilingual role split of the user guide → `docs/pilot/` + `docs/mission-maker/` (19 EN + 19 FR pages); monolith removed (PR #12).

## Tickets

| Ticket | Status | Title |
|---|---|---|
| `01-mission-maker-section` | ✅ done | 01 — Mission Maker section (EN) |
| `02-pilot-section` | ✅ done | 02 — Pilot section (EN) |
| `03-nav-cleanup` | ✅ done | 03 — Nav rewire, remove monolith & fix links (EN) |
| `04-fr-translation` | ✅ done | 04 — French translation (pilot + mission-maker) |
