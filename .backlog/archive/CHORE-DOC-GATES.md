...
**Status:** ✅ merged (PR #39). Compacted from `CHORE-DOC-GATES/` on 2026-08-01; the ticket files live on in git history.
...
| Ticket | Status | Title |
|---|---|---|
| `01-ci-changelog-guard` | ✅ done | 01 — CI CHANGELOG guard job |
| `02-workflow-index-in-pr` | ✅ done | 02 — Model the index-in-PR step + wire the CHANGELOG escape hatch into docs |
