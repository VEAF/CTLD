...
**Status:** delivered. Compacted from `DOC-MKDOCS/` on 2026-08-01; the ticket files live on in git history.

mkdocs-material infra (i18n EN+FR, mike) + `docs.yml` → gh-pages live at veaf.github.io/CTLD (PR #8).
