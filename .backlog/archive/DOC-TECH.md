...
**Status:** delivered. Compacted from `DOC-TECH/` on 2026-08-01; the ticket files live on in git history.

Bilingual `docs/developer/` consolidation (20 EN + 20 FR pages) + workflow page; old sources + `migration/specs/` removed (PR #11).

## Tickets

| Ticket | Status | Title |
|---|---|---|
| `01-structure-landing-architecture` | ✅ done | 01 — Developer section: structure, landing & architecture (EN) |
| `02-subsystems` | ✅ done | 02 — Subsystems page (EN) |
| `03-events-i18n-migration-buildtest` | ✅ done | 03 — Events, i18n, migration & build/test pages (EN) |
| `04-api-reference-design-spec` | ✅ done | 04 — API reference & design spec pages (EN) |
| `05-development-workflow` | ✅ done | 05 — Development workflow page (NEW, required deliverable) |
| `06-nav-links-cleanup` | ✅ done | 06 — mkdocs nav, link fixes & retire old sources (EN) |
| `07-fr-translation` | ✅ done | 07 — French translation of the developer docs |
