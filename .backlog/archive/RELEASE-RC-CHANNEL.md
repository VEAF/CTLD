...
**Status:** ✅ merged (PR #41). Compacted from `RELEASE-RC-CHANNEL/` on 2026-08-01; the ticket files live on in git history.
...
| Ticket | Status | Title |
|---|---|---|
| `01-release-yml-rc-and-latest` | ✅ done | 01 — release.yml: pre-release detection + published-latest floating tag |
| `02-release-skill-rc-aware` | ✅ done | 02 — release skill: rc-aware bump + conditional CHANGELOG freeze |
