...
**Status:** merged (PR #61). Compacted from `FIX-I18N-HARDCODED/` on 2026-08-01; the ticket files live on in git history.

Wrapper dans `ctld.tr()` les chaînes player-facing hardcodées : noms de couches RECON (7) + messages outText AA system (6). Audit codebase complet effectué — seules ces deux zones sont concernées.
...
| Ticket | Status | Title |
|---|---|---|
| `01-recon-layer-names-i18n` | ready | 01 — RECON layer names — wrap ctld.tr() |
| `02-aasystem-messages-i18n` | ready | 02 — AA system messages — wrap ctld.tr() |
