...
**Status:** delivered. Compacted from `DCS-DATAMINE-VENDOR/` on 2026-08-01; the ticket files live on in git history.

Vendored DCS type set (not shipped) + offline config type linter (PR #6).
