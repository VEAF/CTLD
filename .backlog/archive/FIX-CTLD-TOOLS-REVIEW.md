# FIX-CTLD-TOOLS-REVIEW

**Status:** merged (PR #69). Compacted from `FIX-CTLD-TOOLS-REVIEW/` on 2026-08-01; the ticket files live on in git history.

Findings from FullGas's manual review of PR #68 — a data-corrupting editor, double-encoded FR text, a dead catalogue key, and three editor gaps

## Tickets

| Ticket | Status | Title |
|---|---|---|
| `01-review-fixes` | done | 01 — The six findings |
| `02-max-slingload-speed` | done | 02 — `maxSlingloadSpeed` default: 50 → 26 |
